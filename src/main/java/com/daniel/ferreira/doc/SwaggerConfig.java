package com.daniel.ferreira.doc;
...
public class SwaggerConfig {
	...
	private ApiInfoBuilder informacoesApi() {
		...
		apiInfoBuilder.title("Desafio de Projeto de Banco digital DIO");
		apiInfoBuilder.description("API para Projeto de Banco digital DIO\r \n projeto fins didático com o Prof. Venilton FalvoJr");
